...
public static class ProceduralGenerationAlgoritm 
{
    ...
    public static HashSet<Vector2Int> SimpleRandomWalk(Vector2Int startPosistion, int walkLength)
    {
        ...
        {
            var newPosistion = previousPosition + Direction2D.GetRandomCardinalDirection();
            path.Add(newPosistion);
            previousPosition = newPosistion;
        }
        return path;
    }
